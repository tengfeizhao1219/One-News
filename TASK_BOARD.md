...
**一、RQ-22 意见反馈留言板 PRD 已就绪**：`docs/02-产品设计/PRD-RQ22-意见反馈留言板.md`（v0.1）

- 设置页「意见反馈」落地为留言板：留言/回复（多级嵌套楼中楼）/作者角标/筛选删除/合规审核（关键词黑名单+AI）/文明公约页
- 已确认决策：匿名自动昵称 · 仅限频（30s）· AI 失败仅黑名单兜底 · 云数据库存储
- 验收标准 12 条（PRD §六）
...
> **启动**：2026-08-07（PM 建单）| **需求池**：RQ-22（v1.5）| **PRD**：`docs/02-产品设计/PRD-RQ22-意见反馈留言板.md`（v0.1 已就绪）
> **owner 决策**（已确认）：匿名自动昵称 · 多级嵌套回复 · 仅限频（30s）不限字数 · AI 失败仅黑名单兜底 · 云端存储（云数据库）+ 关键词黑名单+AI 校验
