...
| BUG-20260806-007 | D-09 v1.2 系统级落地：导航条带胶囊呼吸（仅下扩 12px）+ 按钮锚定胶囊中心 + 内容起始位置（detail 12rpx / 列表 8rpx）+ 进度条无底槽 | FE | 🔴 | 🔄 已交付待验收（FE `7693b0d`）| D-09 v1.2（owner 13:09 确认）| 6 页面统一实施；PD 按 AC 8 项验收 + owner 真机回归 |
