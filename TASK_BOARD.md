...
> | 编号 | 角色 | 任务 | 优先级 | 依赖 |
> |------|------|------|:---:|------|
> | **UI-B6** | **产品设计师** | **RQ-17 全局返回主页图标设计**：① 🏠 图标精确样式（日间/暗色/hover/尺寸/点击区）；② 详情页导航栏布局（左侧图标 + 居中进度指示）；③ 浏览记录页/收藏列表页导航栏布局（左侧图标 + 居中标题） | 🔴 P0 | PRD §5.7.6 已就绪 |
