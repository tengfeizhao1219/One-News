...
| # | 任务 | 优先级 | 依赖 |
|---|------|--------|------|
| 1 | **A-12a** 技术评审：RQ-01 方案 A/B 定夺 + RQ-10 内容安全 API + RQ-03 存储方案 | 🔴 高 | D-01 ✅ |
| 2 | **A-12b** 交互评审：跨分类衔接交互 + 字体设置 + 收藏/分享按钮 | 🔴 高 | D-01 ✅ |
| 3 | **A-12c** 视觉评审：字号变量规范 + 按钮样式 + 分享卡片兜底 | 🔴 高 | D-01 ✅ |
| 4 | **A-12d** 测试策略预审：跨分类边界/合规拦截/弱网/字体兼容性 | 🟡 中 | D-01 ✅ |
| 5 | 阅读模式·跨分类衔接（同分类翻页已完成，仅缺跨分类） | 🔴 高 | T-01 方案（A-12a） |
| 6 | RQ-10 内容合规审核（接微信内容安全 API） | 🔴 高 | T-01 方案（A-12a），P0 |
| 7 | RQ-04 字体大小调节 | 🟡 中 | D-02/D-03 设计 |
| 8 | RQ-03 收藏 + RQ-07 分享 | 🟡 中 | D-02/D-03 + T-01 存储方案 |
...
> **最后更新**：2026-07-30 | **更新者**：项目经理 | **关联**：项目整体计划 v2.0
