...
// 2026-08-20 二次修复：20s 仍超时（RSS 源站网络响应慢，Duration 21s 全超）——放宽到 40s；
//   云函数超时同步提到 120s（config.json），保证 40s 抓取 + 处理在预算内。
const TIMEOUT_BY_TYPE = { rss: 40000, news: 40000, api: 40000, scrape: 40000, wechat: 5000 }
