      ...
      sections: [
        {
          ...
          label: '新功能',
          items: [
            { title: '官方媒体源接入', desc: '新增中新网、人民网、央视网、新华网等官方媒体，可站内直接阅读' },
            { title: '「一页说」观点卡', desc: '详情页新增 AI 独立观点，针对性生成' },
            { title: '全源 AI 摘要 + 解读', desc: '所有来源的新闻都有 AI 摘要和解读' },
            { title: '翻页更顺滑', desc: '列表翻页动画与交互优化' },
          ],
        },
        {
          type: 'fix',
          label: '修复',
          items: [
            { title: '修复正文乱码', desc: '央视网等部分站点乱码已修复' },
            { title: '修复时间显示', desc: '详情页时间 NaN月NaN日 已恢复正常' },
            { title: '修复新闻重复', desc: '同一条新闻不再重复出现' },
            { title: '修复刷新提示', desc: '下拉刷新状态提示更准确' },
          ],
        },
      ],
    },
