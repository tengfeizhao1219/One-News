      ...
      sections: [
        {
          ...
          label: '新增功能',
          items: [
            { title: '「我的关注」上线', desc: '长按任意正文即可关注话题，每日自动追踪最新进展；在「我的关注」一次看完，支持标已读、改追踪时间、轻松清理' },
            { title: '朋友圈单页阅读', desc: '分享到朋友圈后，好友打开即读一张完整单页，不离开微信也能看到内容' },
            { title: '分享能力升级', desc: '资讯与 AI 情报的详情页均支持「发送给朋友」与「分享到朋友圈」' },
            { title: 'AI 情报官深度进化', desc: '每篇情报都有「原文解读」还原事实；复杂专业文附「大白话」讲给普通读者；「AI 预测」与「落到你这里」帮你看清下一步' },
            { title: '关于一页升级', desc: '新增「产品介绍」与「版本故事」，每个大版本背后的创作历程，等你点开' },
          ],
        },
        {
          type: 'optimization',
          label: '优化',
          items: [
            { title: '打开更快', desc: '详情页首屏本地秒开，AI 情报详情不再等待云端返回' },
            { title: '浏览历史扩至 30 天', desc: '随手翻回更早读过的内容' },
            { title: '极简细节打磨', desc: '详情页阅读进度、底部操作栏、深浅色一致性等大量细节收敛' },
          ],
        },
        {
          type: 'fix',
          label: '修复',
          items: [
            { title: '分享体验修复', desc: '修复从朋友圈打开分享卡片、情报详情分享入口等系列问题' },
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          label: '新增功能',
          items: [
            { title: '新增 AI 情报官模块', desc: '全新智能解读：拆解「发生了什么」「AI 预测」，并结合你的场景落到「你这里」' },
            { title: '实时全网深挖', desc: '对关注的资讯一键全网深挖，汇聚多角度信息' },
          ],
        },
        {
          type: 'optimization',
