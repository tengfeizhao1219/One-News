      ...
      sections: [
        {
          ...
          label: '新功能',
          items: [
            { title: '新闻更全、更权威', desc: '官方媒体直接接入，重要事件覆盖更及时' },
            { title: '每篇都带 AI 摘要', desc: '划几秒就能抓住每条新闻的要点' },
            { title: '「一页说」独立观点', desc: '帮你看懂这篇新闻意味着什么' },
            { title: '阅读更顺滑', desc: '翻页流畅，下拉刷新不再卡顿' },
          ],
        },
        {
          type: 'fix',
          label: '修复',
          items: [
            { title: '不再重复刷屏', desc: '同一篇新闻不再在列表里重复出现' },
            { title: '时间显示准确', desc: '每条新闻都能看到正确的时间' },
            { title: '乱码已修复', desc: '部分页面正文显示恢复正常' },
          ],
        },
      ],
    },
