...
const INTEL_SEED_SOURCES = [
  ...
  },
  {
    ...
    sourceType: 'rss',
    baseUrl: 'https://www.qbitai.com/feed',
    adapterConfig: { endpoint: 'https://www.qbitai.com/feed', timeoutMs: 15000, rateLimit: 'none' },
    pollSeconds: 21600, defaultOn: true, allowCategories: ['ai', 'tech', 'zh'],
    blockTitleKeywords: ['广告', '招聘'],
  },
  {
    ...
    layer: 'F',
    sourceType: 'rss',
    baseUrl: 'https://www.solidot.org/index.rss',
    adapterConfig: { endpoint: 'https://www.solidot.org/index.rss', timeoutMs: 15000, rateLimit: 'none' },
    pollSeconds: 21600, defaultOn: true, allowCategories: ['ai', 'tech', 'open_source'],
    blockTitleKeywords: ['广告'],
  },
  {
    _id: 'geekpark_ai',
