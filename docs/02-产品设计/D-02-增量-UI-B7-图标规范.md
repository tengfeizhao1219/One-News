...
> **状态**：v1.1（v4.1 更新：描边 2→1.25，dock/关闭/主页图标颜色从 text-body/text-primary/home-icon 退让至 text-secondary）
> **owner 要求**：原型内图标需设计好、与 demo 完全一致、去掉 emoji —— 本文档即开发可直接取用的图标清单
> **owner 2026-08-04 反馈**：图标颜色太深 + 线条太粗会吸引用户注意力，除内容外其它元素尽量弱化 → v4.1 描边收细至 1.25、图标颜色统一退让至辅助色 `--text-secondary`（#A0A0A0）
...
- 统一描边宽度 `--icon-stroke: 1.25`，圆角端点 `stroke-linecap: round`、`stroke-linejoin: round`，`fill: none`。
- 颜色**跟随主题 token**（亮/暗双模式），不硬编码色值。
- **图标作为辅助元素应退让**：线条细、颜色淡（统一使用 `--text-secondary` #A0A0A0），不抢内容注意力。唯 fab 浮动按钮上的反色图标保持 `--bg-page` 以保证可读性。
...
| Token | 值 | 说明 |
|-------|----|------|
| `--icon-stroke` | `1.25` | 描边宽度（px，基于 `viewBox="0 0 24 24"`），v4.1 由 2 收细 |
| `fill` | `none` | 禁止填充 |
...
|---|------|------|------|-----------|----------------------|
| 1 | 设置齿轮 Settings | ① 首页右下浮动按钮（fab）；② dock「设置」项 | fab 26px / dock 18px | fab: `var(--bg-page)`（反色）<br>dock: `var(--text-secondary)` | `<circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"/>` |
| 2 | 浏览记录 History | dock「浏览记录」项 | 18px | `var(--text-secondary)` | `<circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/>` |
| 3 | 我的收藏 Favorite | dock「我的收藏」项 | 18px | `var(--text-secondary)` | `<path d="M19 14c1.49-1.46 3-3.21 3-5.5A5.5 5.5 0 0 0 16.5 3c-1.76 0-3 .5-4.5 2-1.5-1.5-2.74-2-4.5-2A5.5 5.5 0 0 0 2 8.5c0 2.3 1.5 4.05 3 5.5l7 7Z"/>` |
| 4 | 扩展位 Plus | dock「扩展位」项 | 18px | `var(--text-secondary)` | `<path d="M5 12h14"/><path d="M12 5v14"/>` |
| 5 | 返回主页 Home | 详情页左上「返回主页」按钮 | 22px | `var(--text-secondary)` | `<path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/>` |
| 6 | 关闭列表 Close | 列表页右上「关闭」按钮 | 16px | `var(--text-secondary)` | `<path d="M18 6 6 18"/><path d="m6 6 12 12"/>` |
